...
* Answer: in that case, the commit already succeeded and was recorded as a placeholder for the consumer.  So when the app restarts it will feed that placeholder to the consumer, and the processing of messages should start where they left off, from the last committed offset before the app crash.
